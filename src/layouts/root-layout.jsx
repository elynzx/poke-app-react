...
export function RootLayout() {
    return (
        <div className="flex items-center justify-center min-h-screen h-dvh w-full font-[Karla] bg-linear-to-b from-bgPink to-bgGreen md:px-6 px-5 overflow-hidden">
            <div className="relative w-full max-w-300 min-h-screen h-dvh py-6 md:py-0 md:h-[90vh] flex flex-col">
                <Header />
