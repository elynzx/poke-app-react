...
export function RootLayout() {
    return (
        <div className="flex items-center justify-center h-screen w-full font-[Karla] bg-linear-to-b from-bgPink to-bgGreen overflow-hidden p-5 md:p-0">
            <div className="relative w-full max-w-7xl h-full md:h-[90vh] flex flex-col">
                <Header />
