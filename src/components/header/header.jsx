...
export const Header = () => {
    ...
    return (
        <header className="absolute left-1/2 -translate-x-1/2 -top-8 md:-top-6 z-40 w-[85%] md:w-[80%]">
            <div className="z-10 w-full backdrop-blur-3xl rounded-2xl px-4 md:px-8 py-1.5 md:py-2 mt-6 flex items-center justify-between border-4 border-white/40 shadow-xl">
                <img
                    src={Logo}
                    alt="PokeAPI"
