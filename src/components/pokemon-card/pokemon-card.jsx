...
export const PokemonCard = ({ pokemon }) => {
    ...
    return (
        <div
            ...
            className="relative w-42 h-60 flex flex-col items-center justify-end group"
        >
            <div className="absolute -top-3 z-10 w-full h-38 flex justify-center items-center pointer-events-none transition-transform duration-300 group-hover:scale-110">
                <img
                    src={image}
                    alt={name}
            ...
            <div className="relative w-full h-35 pb-6 flex flex-col items-center justify-end bg-white/20 backdrop-blur-md border border-white/50 rounded-b-xl  rounded-t-4xl shadow-2xs shadow-white transition-all duration-300 group-hover:bg-white/40 cursor-pointer">
